<x-layouts.admin page-title="Управление сайтом" title="Управление сайтом">
    <section class="pb-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6">
            <div class="bg-white w-full border border-gray-100 rounded overflow-hidden shadow-lg hover:shadow-2xl pt-4">
                <a class="flex w-full h-40 text-orange justify-center hover:opacity-75" href="{{route('admin.admin')}}">
                ...
                <div class="px-6 py-4 text-center">
                    <div class="text-black font-bold text-xl mb-2"><a class="hover:text-orange" href="{{route('admin.admin')}}">Управление моделями</a></div>
                </div>
            </div>
            <div class="bg-white w-full border border-gray-100 rounded overflow-hidden shadow-lg hover:shadow-2xl pt-4">
