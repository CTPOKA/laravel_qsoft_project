...
<section class="pb-4">
    <div class="my-6">
        <a href="admin_article_form.html" class="inline-block bg-orange hover:bg-opacity-70 focus:outline-none text-white font-bold py-2 px-4 rounded" title="Добавить новость">
        ...
        <tr>
            ...
            <td class="border px-4 py-2">
                <div class="flex items-center">
                    <a href="admin_article_form.html" class="inline-block bg-orange hover:bg-opacity-70 focus:outline-none text-white font-bold py-2 px-4 rounded" title="Редактировать">
